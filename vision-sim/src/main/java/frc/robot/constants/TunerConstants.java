...
public class TunerConstants {
        ...
        public static final SwerveDrivetrainConstants SIM_DRIVETRAIN_CONSTANTS = DrivetrainConstants;
        ...
        private static final double kFrontLeftEncoderOffset = 0.2314453125 - .5;
        ...
        private static final double kFrontRightEncoderOffset = -0.35205078125 + .5;
        ...
        private static final double kBackLeftEncoderOffset = 0.42822265625 - .5;
        ...
        private static final double kBackRightEncoderOffset = 0.056884765625;
        ...
        public static final SwerveModuleConstants SimFrontLeft = ConstantCreator.createModuleConstants(
                        kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId, kFrontLeftEncoderOffset,
                        Units.inchesToMeters(kFrontLeftXPosInches), Units.inchesToMeters(kFrontLeftYPosInches),
                        kInvertLeftSide);
        public static final SwerveModuleConstants SimFrontRight = ConstantCreator.createModuleConstants(
                        kFrontRightSteerMotorId, kFrontRightDriveMotorId, kFrontRightEncoderId,
                        kFrontRightEncoderOffset, Units.inchesToMeters(kFrontRightXPosInches),
                        Units.inchesToMeters(kFrontRightYPosInches), kInvertRightSide);
        public static final SwerveModuleConstants SimBackLeft = ConstantCreator.createModuleConstants(
                        kBackLeftSteerMotorId, kBackLeftDriveMotorId, kBackLeftEncoderId, kBackLeftEncoderOffset,
                        Units.inchesToMeters(kBackLeftXPosInches), Units.inchesToMeters(kBackLeftYPosInches),
                        kInvertLeftSide);
        public static final SwerveModuleConstants SimBackRight = ConstantCreator.createModuleConstants(
                        kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId, kBackRightEncoderOffset,
                        Units.inchesToMeters(kBackRightXPosInches), Units.inchesToMeters(kBackRightYPosInches),
                        kInvertRightSide);

        public static SwerveModuleConstants[] createSimDrivetrain() {
                SwerveModuleConstants[] modules = new SwerveModuleConstants[4];
                modules[0] = SimFrontLeft;
                modules[1] = SimFrontRight;
                modules[2] = SimBackLeft;
                modules[3] = SimBackRight;
                return modules;
        }
